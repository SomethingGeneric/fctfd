...
def scoreboard():
    ...
    sb_html = '<div class="grid-container">' if not SMALL_SB else "<ul><h2><img class=\"gang\" src=\"/static/Buddies.png\"/> Scoreboard</h2><h3>Register to submit flags at: https://score.goober.cloud/teams/new</h3><br/><h3>List of challenges: https://score.goober.cloud/challenges</h3>"
